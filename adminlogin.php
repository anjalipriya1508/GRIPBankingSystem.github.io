...
<tr  style="padding-top:50px;  padding-bottom:50px ;"><td colspan=2 style="font-size:48px;text-align:center;color:white;background-color:#00006f;font-weight:bold;">Admin Login</td></tr>
<tr ><td style="font-size:32px;color:white;">UserId</td><td><input  type="text1" name="text1" style="font-size:32px;width:100%;height:100%"></td></tr>
