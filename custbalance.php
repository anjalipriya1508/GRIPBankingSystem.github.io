...
<div class=" col-xs-9" >
<div class="row" style="color:white;font-weight:bold;font-size:72px;text-align:center;"><img src="bankname.png" class="img-responsive  fill"  style="width:100%;object-fit:fill;" ></div></div>
...
<tr ><td colspan=2 style="font-size:32px;color:white;background-color:black; text-align:center;font-weight:bold;" >Balance Amount</td></tr>
<?php
include("connection.php");
session_start();
$v1=$_SESSION['acno'];

$sqlvar="select (sum(dbAmt)-sum(crAmt)) as Balance  from transaction where acno=$v1";
$result=$conn->query($sqlvar);
while($row=$result->fetch_row()){
echo("<tr><td id='m'>Balance Amount</td><td id='m'>".$row[0]."</td></tr>");
}
?>
